    ...
    'connect_relay': [
        {
            ...
            'tests': ['tests/test_connect_relay_local_negatives.py::ConnectRelayIndependentLocalNegativeTests::test_http2_connect_policy_deny_and_allowlist_rejection_end_stream'],
        ...
        },
        {
            ...
            'expected_action': 'reject_response',
            'expected_outcome': '403 connect denied and end stream',
            'tests': ['tests/test_connect_relay_local_negatives.py::ConnectRelayIndependentLocalNegativeTests::test_http3_connect_policy_deny_and_allowlist_rejection_end_stream'],
            'preserved_artifacts': ['docs/review/conformance/releases/0.3.9/release-0.3.9/tigrcorn-connect-relay-local-negative-artifacts'],
        },
    ],
    'tls_x509': [
