...
def test_connect_relay_independent_docs_and_status_exist() -> None:
    assert (CONFORMANCE / 'CONNECT_RELAY_INDEPENDENT_CONNECT_RELAY_INDEPENDENT_CLOSURE.md').exists()
    assert (CONFORMANCE / 'connect_relay_independent_connect_relay_independent.current.json').exists()
    assert (ROOT / 'docs/review/conformance/delivery/DELIVERY_NOTES_CONNECT_RELAY_INDEPENDENT_CONNECT_RELAY_INDEPENDENT_CLOSURE.md').exists()

    payload = _load_json(CONFORMANCE / 'connect_relay_independent_connect_relay_independent.current.json')
...
def test_connect_relay_independent_release_root_contains_connect_artifacts_and_local_negative_vectors() -> None:
...
def test_connect_relay_independent_strict_boundary_reports_connect_as_partial_artifact_failure_not_unknown_scenarios() -> None:
