...
def test_initial_secret_and_keys_match_rfc9001_appendix_a():
...
def test_header_protection_mask_matches_rfc9001_appendix_a2():
    cid = bytes.fromhex('8394c8f03e515708')
    client, _server = derive_initial_packet_protection_keys(cid)
    sample = bytes.fromhex('d1b1c98dd7689fb8ec11d242b123dc9b')
    assert aes_header_protection_mask(client.hp, sample).hex() == '437b9aec36'


def test_client_initial_packet_matches_rfc9001_appendix_a2():
    cid = bytes.fromhex('8394c8f03e515708')
    client, _server = derive_initial_packet_protection_keys(cid)
...
def test_server_initial_packet_matches_rfc9001_appendix_a3():
    cid = bytes.fromhex('8394c8f03e515708')
...
def test_retry_integrity_tag_matches_rfc9001_appendix_a4():
    cid = bytes.fromhex('8394c8f03e515708')
    retry_without_tag = bytes.fromhex('ff000000010008f067a5502a4262b5746f6b656e')
    assert (
        compute_retry_integrity_tag(retry_without_tag, cid).hex()
        == '04a265ba2eff4d829058fb3f0f2496ba'
    )


def test_key_update_secret_matches_rfc9001_appendix_a5():
