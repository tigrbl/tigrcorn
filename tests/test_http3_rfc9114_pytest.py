...
def test_control_stream_prefix_and_settings():
...
def test_goaway_uses_varint_payload():
    core = HTTP3ConnectionCore()
...
def test_validate_request_headers_rejects_duplicates():
...
def test_validate_request_headers_rejects_connection_specific():
    async def app(scope, receive, send):
        return None
