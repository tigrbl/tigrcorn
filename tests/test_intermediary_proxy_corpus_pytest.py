...
def test_index_lists_seed_corpus_cases() -> None:
...
def test_http11_seed_case_preserves_third_party_artifacts() -> None:
    ...
    assert metadata['peer'] == 'curl'
    assert result['passed']


def test_connect_cases_preserve_local_vector_metadata() -> None:
    for carrier in ('http11', 'http2', 'http3'):
        ...
        assert vector['name'] == 'http-connect-relay'
