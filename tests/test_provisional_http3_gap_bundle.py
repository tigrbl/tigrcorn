...
class ProvisionalHttp3GapBundleTests(unittest.TestCase):
    def test_bundle_index_registers_relative_non_certifying_bundle(self) -> None:
        ...
        self.assertIn('explicitly non-certifying', '\n'.join(payload['notes']))

    def test_mapping_file_covers_all_missing_scenarios(self) -> None:
