...
EXPECTED_VECTOR_CATALOG = {
    ...
    '9000-deep': {'name': 'quic-packet-space-legality-deep', 'protocol': 'quic-transport', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '9001': {'name': 'quic-tls-initial-vectors', 'protocol': 'quic-tls', 'fixture': 'tests/test_quic_tls_rfc9001.py'},
    '9001-deep': {'name': 'quic-tls-protection-deep', 'protocol': 'quic-tls', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '9002': {'name': 'quic-recovery', 'protocol': 'quic-recovery', 'fixture': 'tests/test_quic_recovery_rfc9002.py'},
    '9002-deep': {'name': 'quic-recovery-edge-cases-deep', 'protocol': 'quic-recovery', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    ...
    '9114-deep': {'name': 'http3-request-control-strictness-deep', 'protocol': 'http3', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '9114-section-10-9': {'name': 'http3-early-data-section-10-9', 'protocol': 'http3-early-data', 'fixture': 'tests/test_governed_rfc_support_floor.py'},
    '9114-section-10-9-deep': {'name': 'http3-early-data-section-10-9-deep', 'protocol': 'http3-early-data', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '9204': {'name': 'qpack-dynamic-state', 'protocol': 'http3-qpack', 'fixture': 'tests/test_qpack_completion.py'},
    '9221': {'name': 'quic-datagram-frame', 'protocol': 'quic-datagram', 'fixture': 'tests/test_governed_rfc_support_floor.py'},
    '9221-deep': {'name': 'quic-datagram-frame-deep', 'protocol': 'quic-datagram', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '9220': {'name': 'http3-websocket-extended-connect', 'protocol': 'http3-websocket', 'fixture': 'tests/test_http3_websocket_rfc9220.py'},
    '9297': {'name': 'http-datagram-h3-carrier', 'protocol': 'http3-datagram', 'fixture': 'tests/test_governed_rfc_support_floor.py'},
    '9297-deep': {'name': 'http-datagram-h3-carrier-deep', 'protocol': 'http3-datagram', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '8470': {'name': 'http-early-data-policy', 'protocol': 'http-early-data', 'fixture': 'tests/test_governed_rfc_support_floor.py'},
    '8470-deep': {'name': 'http-early-data-policy-deep', 'protocol': 'http-early-data', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '3986': {'name': 'uri-generic-syntax-request-target', 'protocol': 'uri', 'fixture': 'tests/test_governed_rfc_support_floor.py'},
    '3986-deep': {'name': 'uri-generic-syntax-request-target-deep', 'protocol': 'uri', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '9308': {'name': 'quic-applicability-profile', 'protocol': 'quic-applicability', 'fixture': 'tests/test_governed_rfc_support_floor.py'},
    '9308-deep': {'name': 'quic-applicability-profile-deep', 'protocol': 'quic-applicability', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
    '9312': {'name': 'quic-manageability-observability', 'protocol': 'quic-manageability', 'fixture': 'tests/test_governed_rfc_support_floor.py'},
    '9312-deep': {'name': 'quic-manageability-observability-deep', 'protocol': 'quic-manageability', 'fixture': 'tests/test_governed_rfc_deep_coverage.py'},
