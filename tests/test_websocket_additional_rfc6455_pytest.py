...
async def test_accept_rejects_extension_negotiation():
    sender = _WSAppSend(
        writer=type(
            "W",
            (),
...
async def test_invalid_utf8_text_message_closes_with_1007():
...
async def test_fragmented_message_limit_closes_with_1009():
    disconnects: list[dict] = []
