...
class ExternalCurrentReleaseMatrixTests(unittest.TestCase):
    def test_current_release_matrix_document_covers_expected_peers_and_dimensions(self):
        ...
        self.assertEqual(matrix.metadata['canonical_release_root'], 'docs/review/conformance/releases/0.3.9/release-0.3.9/tigrcorn-mixed-compatibility-release-matrix')
