...
This directory contains delivery notes and checkpoint handoff notes that used to accumulate at the repository root.
...
Root-level `DELIVERY_NOTES*.md` files are intentionally not used; they were consolidated here to keep the repository root focused on package entrypoint documents.
