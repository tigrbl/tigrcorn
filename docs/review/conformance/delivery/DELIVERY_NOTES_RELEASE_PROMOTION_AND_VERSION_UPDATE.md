# Delivery notes — Release certification release promotion and version update
...
- added `docs/review/conformance/RELEASE_PROMOTION_AND_VERSION_UPDATE.md`
