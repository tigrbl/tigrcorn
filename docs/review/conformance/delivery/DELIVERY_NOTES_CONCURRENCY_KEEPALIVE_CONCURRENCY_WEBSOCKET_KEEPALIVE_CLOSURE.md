# Delivery notes — Concurrency keepalive concurrency and WebSocket keepalive closure

This checkpoint closes the remaining public flag/runtime gaps from Release certificationF:
