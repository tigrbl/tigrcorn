# Delivery notes — OCSP certification OCSP independent-certification closure

This checkpoint advances **OCSP certification** of the Release certification implementation plan.
