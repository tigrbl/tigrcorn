# Delivery notes — Promotion contract promotion-contract freeze

This checkpoint executes the documentation / contract-freeze work for Promotion contract.

What changed:

- reserved the next promotable release root at `docs/review/conformance/releases/0.3.8/release-0.3.8/`
- added a machine-readable Promotion contract promotion-contract status snapshot
...
- updated current-state and README-style documentation to point at the Promotion contract checkpoint
