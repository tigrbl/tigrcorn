...
The repository is now **certifiably fully featured** and **strict-target certifiably fully RFC compliant** under the evaluated 0.3.9 working release root. Historical earlier checkpoints remain preserved as historical records.
