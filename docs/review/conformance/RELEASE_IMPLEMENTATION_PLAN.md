# Release certification implementation plan

> **Update:** Promotion contract is now executed in-tree through `docs/review/conformance/PROMOTION_CONTRACT_PROMOTION_CONTRACT_FREEZE.md`, `docs/review/conformance/PROMOTION_CONTRACT_EXECUTION_BACKLOG.md`, `docs/review/conformance/promotion_contract_promotion_contract.current.json`, and `docs/review/conformance/promotion_contract_execution_backlog.current.json`. The remaining critical path now starts at Independent harness, while the frozen 9A contract remains the governing execution baseline.
...
## Current truth at the start of Release certification
...
## Promotion contract — freeze the promotion contract
...
## Independent harness — shared independent-certification harness foundation
...
## RFC 7692 independent closure — RFC 7692 independent-certification closure
...
## Release certificationD — RFC 9110 bounded semantic closure at independent tier
...
## OCSP certification — RFC 6960 independent-certification closure
...
## Release certificationF — public flag contract/runtime closure
...
### Exit criteria for Release certificationF
...
## Strict performance — strict performance target closure
...
- Independent harness foundation
- RFC 7692 independent closure RFC 7692
- Release certificationD RFC 9110 bounded semantics
- OCSP certification RFC 6960

### Stream B — runtime / flag closure

- Promotion contract contract freeze
- Release certificationF TLS, observability, scheduler, keepalive closures

### Stream C — performance and release gates

- Promotion contract contract freeze
- Strict performance performance closure
