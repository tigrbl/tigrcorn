...
That root contains the canonical independent bundle, the canonical same-stack replay bundle, and the preserved mixed compatibility bundle for the current package version.
