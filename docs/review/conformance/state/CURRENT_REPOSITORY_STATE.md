...
- `docs/review/conformance/RELEASE_PROMOTION_AND_VERSION_UPDATE.md`
...
- `docs/review/conformance/package_compliance_review_release_assembly.current.json`
- `docs/review/conformance/STRICT_RELEASE_VALIDATION.md`
...
- `docs/review/conformance/delivery/DELIVERY_NOTES_RELEASE_PROMOTION_AND_VERSION_UPDATE.md`
...
## Release certification release-promotion checkpoint
...
## Promotion contract promotion-contract-freeze checkpoint

The historical Promotion contract promotion-contract-freeze checkpoint remains part of the current provenance chain:
...
- the release workflow must install `.[certification,dev]` before any Release certification checkpoint script is executed
- `tools/run_release_certification_release_workflow.py` freezes and validates the certification environment before it invokes Release certification checkpoint scripts
- a non-ready local environment is recorded honestly instead of being treated as an acceptable release-workflow substitute

## Release certification implementation-plan checkpoint
...
## Release certification final-promotion and automated-release checkpoint

The current working tree now also carries the Release certification automated-release control-plane surface.
...
- `scripts/ci/validate.sh` and the reusable CI workflow now regenerate and retain the Release certification release-automation artifacts as part of the canonical mutable-tree validation path
...
- the frozen canonical `0.3.9` release root has not been regenerated or superseded with the new mutable Release certification release-automation artifacts
