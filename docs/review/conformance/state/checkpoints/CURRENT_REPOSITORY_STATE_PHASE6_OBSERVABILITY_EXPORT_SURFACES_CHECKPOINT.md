...
- CI now regenerates the Phase 6 artifacts and runs `tests/test_observability_surface.py` together with `tests/test_observability_surface_logging_exporter_closure.py`.
...
- `python -m unittest tests.test_observability_surface_logging_exporter_closure`
