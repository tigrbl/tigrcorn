...
| `Risk traceability` | `P8` | SSOT risk rows plus traceability | governance and promotion discipline | in-bounds candidate | `.ssot/registry.json`, policy/docs | schema, ID uniqueness, referential integrity |
