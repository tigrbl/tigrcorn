...
COMMIT_HASH = 'independent_harness-independent-harness-foundation'
...
def main() -> int:
    ...
    release_manifest.update(
        {
            'status': 'independent_harness_harness_foundation_complete_not_yet_promotable',
            'promotion_ready': False,
            'strict_target_complete': False,
            'source_checkpoint': 'independent_harness_independent_harness_foundation',
            ...
            'notes': [
                'This release root now contains the Independent harness independent harness foundation proof bundle.',
    ...
    (RELEASE_ROOT / 'README.md').write_text(
        ...
        'Independent harness adds the shared independent-certification harness foundation proof bundle at:\n\n'
